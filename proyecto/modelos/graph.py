"""
Grafo del esqueleto humano
==========================
Copiado de mmskeleton/ops/st_gcn/graph.py (solo depende de numpy).
Sin dependencia de mmcv.

Layouts disponibles:
  - openpose:  18 joints (Kinetics)
  - ntu-rgb+d: 25 joints (NTU RGB+D)
  - ntu_edge:  24 joints
  - coco:      17 joints

Estrategias de partición:
  - uniform:  1 partición — todos los vecinos igual
  - distance: K particiones — por distancia de salto
  - spatial:  3 particiones — self-loop / centripetal / centrifugal
"""
    ...
    def get_edge(self, layout):
        if layout == 'openpose':
            ...
            raise ValueError(f"Layout desconocido: '{layout}'. "
                             f"Opciones: openpose, ntu-rgb+d, ntu_edge, coco")
    ...
    def get_adjacency(self, strategy):
        ...
        if strategy == 'uniform':
            ...
            raise ValueError(f"Estrategia desconocida: '{strategy}'. "
                             f"Opciones: uniform, distance, spatial")
